    ...
    if ($result && $statement->rowCount() > 0) { ?>
        ...
        <?php foreach ($result as $row) { ?>
            <tr>
                ...
                <td><div height="100px" width="100px"><td><a href="view.php?rand=<?php echo $row["rand"]; ?>"><?php echo $row["rand"]; ?><img src="view.php?rand=<?php echo $row["rand"]; ?>" alt="Smiley face" height="42" width="42"></a></td></td>
            </tr>
        <?php } ?>
        </tbody>
    </table>
